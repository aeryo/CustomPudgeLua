...
function _SetInitialValues()
  print("\n\nHej\n\n")
  self.thinkState = Dynamic_Wrap( FrotaGameMode, '_thinkState_Move' )
  self._scriptBind:BeginThink( "CustomPudgeThinkMove", Dynamic_Wrap( FrotaGameMode, 'Think' ) , 0.01 ) 
end

-- Called from the addon in charge to initialize this class
function InitGameModePudge()
  print("\n\n Pudgewars \n\n")
  PudgeArray = {}
  for i=0, 9 do
    PudgeArray[i] = {}
...
function FrotaGameMode:_thinkState_Move( dt )
    print("working...")
